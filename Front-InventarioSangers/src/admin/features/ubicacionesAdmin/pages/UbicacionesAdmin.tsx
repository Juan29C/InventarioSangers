import { Edit, Plus, Search, Trash2, Eye, AlertCircle, Map } from "lucide-react"
...
export default function UbicacionesAdmin() {
    ...
    const handleSubmit = (ubicacion: any) => {
        console.log("Nueva ubicación:", ubicacion)
        // Aquí puedes agregar la lógica para enviar los datos al backend
        // Por ejemplo: await crearUbicacion(ubicacion)
    }
                    ...
                    <table className="w-full">
                        <thead className="border-b bg-slate-50 border-slate-200">
                            <tr>
                                ...
                                <th className="px-6 py-4 text-xs font-semibold tracking-wider text-center uppercase text-slate-600">Nombre</th>
                        ...
                        <tbody className="divide-y divide-slate-200">
                            ...
                            {!loading &&
                                currentData.map((item) => (
                                    <tr key={item.id} className="transition-colors hover:bg-slate-50 items-center">
                                        <td className="px-6 py-4 text-center whitespace-nowrap">
                                            <div className="text-sm font-medium text-slate-900">{item.fecha}</div>
                                        </td>
                                        <td className="px-6 py-4 text-center">
                                            <div className="max-w-xs mx-auto">
                                                <p className="text-sm font-medium text-slate-900 line-clamp-2">{item.nombre}</p>
                                            </div>
                                        </td>
                                        <td className="px-6 py-4 text-center whitespace-nowrap">
